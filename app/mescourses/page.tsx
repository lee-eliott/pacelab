...
function EvolutionChart({ activities, associations, hoveredId, selectedId, onHover, onSelect, timeField, stravaCompagnons, compagnonsPacelab, sortedCompagnons, compColors }: {
    ...
    <div>
      ...
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10}}>
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          ...
          {activities.some(a => (a.athlete_count??1)>1) && <span style={{fontSize:10,color:"var(--text-dim)",fontFamily:"var(--font-geist)"}}>🟢 = course en groupe</span>}
        </div>
      ...
      <main style={{ padding: "24px", maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: 24 }}>
          <div>
            ...
            <h1 style={{ fontSize: 22, fontWeight: 500, color: "#fff", margin: 0 }}>Mes Courses</h1>
          </div>
          {connected && (
          ...
          <>
            ...
            {data?.athlete && (
              <div style={{ display: "flex", alignItems: "center", gap: 16, ...card, marginBottom: 12 }}>
                <div style={{ width: 48, height: 48, borderRadius: "50%", background: "rgba(252,76,2,0.15)", border: "2px solid #FC4C02", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, fontWeight: 500, color: "#FC4C02", fontFamily: "var(--font-geist)", overflow: "hidden", flexShrink: 0 }}>
            ...
            <div style={{ ...card, padding: 0, overflow: "hidden" }}>
              ...
              <div style={{display:"flex",gap:24,flexWrap:"wrap",marginTop:14,paddingTop:14,borderTop:"0.5px solid var(--border)"}}>
                {[
                  ...
                  {l:"Allure moy.",v:allureMoyFiltered},
                ].map(({l,v})=>(
                  <div key={l}>
